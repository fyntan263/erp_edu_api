...
//
//    @PostMapping
//    public ResponseEntity<Payment> createPayment(@Valid @RequestBody PaymentCreationRequest request) {
...
//        List<Payment> payments = paymentService.getPaymentsBypayeeId(studentId);
